export const mockProducts = [
  {
    ...
    Amount: 100,
    Price: 25,
    Description: "สับปะรดสดใหม่ปลูกแบบออร์แกนิก ไม่มีสารเคมี",
    Details: "สับปะรดปลูกจากฟาร์มชาวไร่ที่ใช้วิธีการเกษตรแบบตามธรรมชาติ ทำให้ได้ผลผลิตที่มีคุณภาพสูง อร่อย และปลอดภัยต่อสุขภาพ",
    HarvestedAt: "2024-05-15T10:00:00Z",
    images: [
      { imageUrl: "/pineapple/PN.png" },
      { imageUrl: "/pineapple/PP.png" }
    ],
    farmer: {
      id: 1,
