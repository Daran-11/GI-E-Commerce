export const mockProducts = [
    ...
    certificates: [
      {
        certificate: {
          ...
          standards: JSON.stringify([
            {
              name: "มาตรฐาน GAP",
              certNumber: "GAP-2024-002",
              certDate: "2024-02-20T00:00:00Z",
              logo: "/images/gap-cert.png"
            }
          ]),
  ...
  },
  {
    ...
    images: [
      { imageUrl: "/images/pineapple1.jpg" },
      { imageUrl: "/images/pineapple2.jpg" }
    ],
    farmer: {
      id: 3,
    ...
    certificates: [
      {
        certificate: {
          ...
          standards: JSON.stringify([
            {
              name: "เกษตรอินทรีย์ไทย",
              certNumber: "ORG-TH-2024-003",
              certDate: "2024-03-10T00:00:00Z",
              logo: "/images/thai-organic.png"
            }
          ]),
