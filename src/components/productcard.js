    ...
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 lg:gap-[30px] xl:gap-[30px] ">
        {products.map((product) => (
              ...
              <div key={product.ProductName} className="Card flex-col justify-center w-full h-[350px] md:h-[380px] lg:h-[350px] xl:h-full rounded-2xl bg-[#FBFBFB] shadow-lg transition duration-500 ease-in-out transform hover:scale-105 ">
                  ...
                  <div className="px-[18px] h-[70px]">
                      ...
                      <div className="mt-[2px] text-[#767676] text-xl ">
                  ...
                  <div className= 'xl:flex md:grid md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2  px-[18px] pt-[10px] text-[#4eac14] flex justify-between items-center border-t-[1px]'>
                      <p className=' sm:text-[19px]  md:text-[25px]  lg:text-[23px] xl:text-[25px]'> ฿{Number(product.Price).toLocaleString()}</p>     
                      <p>/กิโลกรัม</p>      



                  </div>
                  <div className='px-[18px] mt-[10px] mb-[10px]'>
