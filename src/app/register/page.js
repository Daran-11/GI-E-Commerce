      ...
      <div className="mt-[50px]">
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="input-position">
            ...
            />
            {nameError && (
              <div className="input-error isCorrect ? 'border-green-500' : 'border-red-500'">
                {nameError}
              </div>
            )}
          </div>
          ...
          {error && (
            <div className="bg-red-500 text-sm text-white py-1 px-3">
              {error}
            </div>
          )}
          {successMessage && (
            <div className="bg-green-500 text-sm text-white py-1 px-3">
              {successMessage}
            </div>
          )}
          <button
            className="bg-[#4EAC14] text-white p-2 my-2 rounded-2xl w-[90px]"
            type="submit"
          >
            {" "}
            สมัคร{" "}
